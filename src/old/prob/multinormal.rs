...
// Perhaps store a Vec<(usize, usize)> holding parent and child nodes in a graph matching
// indices of the mean vector and covariance matrices. The log-prob can be calculated as
// the sum over the log-probs of the nodes, instead of a full log-prob calculation requiring
...
impl MultiNormal {
    ...
    pub fn natural_mut<'a>(&'a mut self) -> DVectorSliceMut<'a, f64> {
